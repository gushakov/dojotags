define([ "dojo/request", "dojo/Deferred" ], function(request, Deferred) {
	return {
		 ...
		 * 
		 * @param {Object}
		 *            args Ajax call properties <code>path</code> Full path on
		 *            the server <code>data</code> Data in serialized (Json)
		 *            form <code>sync</code> Whether the request should be
